...
ALLOWED_HOSTS = ['senademo.herokuapp.com']
...
SECRET_KEY = 'ao_%sd^9_9%$_-+p%y@347v4!e9x(da2yj6jg6ej(3srrw@yr$'
...
#aqui va la configuracion del servidor del correo GMAIL
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = '587'
EMAIL_HOST_USER = 'micorreo@gmail.com'
EMAIL_HOST_PASSWORD = 'miclave'
EMAIL_USE_TLS = True

#Identificacar o definir el perfil de los ususarios
